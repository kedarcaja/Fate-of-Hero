...
public class sit : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        void Update()
        {
            ...
            {
                Vector3 targetDir;
                targetDir = new Vector3(transform.position.x - character.transform.position.z, 0f, transform.position.z - character.transform.position.z);
